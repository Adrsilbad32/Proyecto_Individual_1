...
@app.get("/")
def idex():
	return {'Mensaje':'Bienvenidos.Para su uso solo tienen que copiar los links y en el ultimo / poner los valores que desean pero solo funciona con lo que dice, por ejemplo si dice genero no va a funcionar poniendo anio',
